...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220112060942_remove_BusinessId")]
    partial class remove_BusinessId
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 12, 14, 9, 42, 436, DateTimeKind.Local).AddTicks(6172),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 12, 14, 9, 42, 436, DateTimeKind.Local).AddTicks(1073),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 12, 14, 9, 42, 433, DateTimeKind.Local).AddTicks(8785),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 12, 14, 9, 42, 436, DateTimeKind.Local).AddTicks(2554),
                            IsDelete = false,
