...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20211213050138_update_sysuser")]
    partial class update_sysuser
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2021, 12, 13, 13, 1, 38, 280, DateTimeKind.Local).AddTicks(4896),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 13, 13, 1, 38, 280, DateTimeKind.Local).AddTicks(179),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 13, 13, 1, 38, 277, DateTimeKind.Local).AddTicks(8863),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2021, 12, 13, 13, 1, 38, 280, DateTimeKind.Local).AddTicks(1311),
                            IsDelete = false,
