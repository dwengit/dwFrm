...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20211212034251_remove_test")]
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 12, 11, 42, 51, 89, DateTimeKind.Local).AddTicks(8422),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 12, 11, 42, 51, 89, DateTimeKind.Local).AddTicks(3849),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountCode = "123456",
                            ContactInformation = "",
                            CreateTime = new DateTime(2021, 12, 12, 11, 42, 51, 87, DateTimeKind.Local).AddTicks(2729),
                            Education = "",
                            Gender = 1,
                            Hobby = "",
                            Introduce = "管理员",
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2021, 12, 12, 11, 42, 51, 89, DateTimeKind.Local).AddTicks(5139),
                            IsDelete = false,
