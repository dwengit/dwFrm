...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20211220131413_add_sys_login_log")]
    partial class add_sys_login_log
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2021, 12, 20, 21, 14, 12, 759, DateTimeKind.Local).AddTicks(6653),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 20, 21, 14, 12, 758, DateTimeKind.Local).AddTicks(9197),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 20, 21, 14, 12, 755, DateTimeKind.Local).AddTicks(3599),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2021, 12, 20, 21, 14, 12, 759, DateTimeKind.Local).AddTicks(927),
                            IsDelete = false,
