...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220115135004_add_articletag")]
    partial class add_articletag
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 15, 21, 50, 4, 47, DateTimeKind.Local).AddTicks(5832),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 15, 21, 50, 4, 47, DateTimeKind.Local).AddTicks(3240),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 15, 21, 50, 4, 46, DateTimeKind.Local).AddTicks(1188),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 15, 21, 50, 4, 47, DateTimeKind.Local).AddTicks(3885),
                            IsDelete = false,
