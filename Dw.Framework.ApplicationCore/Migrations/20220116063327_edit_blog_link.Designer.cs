...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220116063327_edit_blog_link")]
    partial class edit_blog_link
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 16, 14, 33, 26, 992, DateTimeKind.Local).AddTicks(5415),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 16, 14, 33, 26, 992, DateTimeKind.Local).AddTicks(969),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 16, 14, 33, 26, 989, DateTimeKind.Local).AddTicks(7309),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 16, 14, 33, 26, 992, DateTimeKind.Local).AddTicks(2029),
                            IsDelete = false,
