...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20211220080450_add_sys_oper_log")]
    partial class add_sys_oper_log
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2021, 12, 20, 16, 4, 50, 488, DateTimeKind.Local).AddTicks(3465),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 20, 16, 4, 50, 487, DateTimeKind.Local).AddTicks(9439),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 20, 16, 4, 50, 486, DateTimeKind.Local).AddTicks(6374),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2021, 12, 20, 16, 4, 50, 488, DateTimeKind.Local).AddTicks(480),
                            IsDelete = false,
