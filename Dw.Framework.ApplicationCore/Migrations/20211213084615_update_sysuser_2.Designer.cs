...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20211213084615_update_sysuser_2")]
    partial class update_sysuser_2
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2021, 12, 13, 16, 46, 15, 454, DateTimeKind.Local).AddTicks(3496),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 13, 16, 46, 15, 453, DateTimeKind.Local).AddTicks(9187),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 12, 13, 16, 46, 15, 452, DateTimeKind.Local).AddTicks(178),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2021, 12, 13, 16, 46, 15, 454, DateTimeKind.Local).AddTicks(228),
                            IsDelete = false,
