...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220104145845_add_blog_tabls")]
    partial class add_blog_tabls
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 4, 22, 58, 44, 360, DateTimeKind.Local).AddTicks(4342),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 4, 22, 58, 44, 359, DateTimeKind.Local).AddTicks(6215),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 4, 22, 58, 44, 355, DateTimeKind.Local).AddTicks(7308),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 4, 22, 58, 44, 359, DateTimeKind.Local).AddTicks(8176),
                            IsDelete = false,
