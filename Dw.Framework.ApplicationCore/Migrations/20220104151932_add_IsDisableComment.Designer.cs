...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220104151932_add_IsDisableComment")]
    partial class add_IsDisableComment
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 4, 23, 19, 31, 644, DateTimeKind.Local).AddTicks(9603),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 4, 23, 19, 31, 644, DateTimeKind.Local).AddTicks(3430),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 4, 23, 19, 31, 641, DateTimeKind.Local).AddTicks(9250),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 4, 23, 19, 31, 644, DateTimeKind.Local).AddTicks(5312),
                            IsDelete = false,
