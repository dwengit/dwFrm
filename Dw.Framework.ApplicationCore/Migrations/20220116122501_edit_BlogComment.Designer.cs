...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220116122501_edit_BlogComment")]
    partial class edit_BlogComment
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 1, 16, 20, 25, 0, 653, DateTimeKind.Local).AddTicks(9468),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 16, 20, 25, 0, 653, DateTimeKind.Local).AddTicks(4876),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 1, 16, 20, 25, 0, 651, DateTimeKind.Local).AddTicks(2175),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 1, 16, 20, 25, 0, 653, DateTimeKind.Local).AddTicks(6055),
                            IsDelete = false,
