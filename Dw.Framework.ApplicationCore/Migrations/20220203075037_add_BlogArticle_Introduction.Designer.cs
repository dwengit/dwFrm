...
namespace Dw.Framework.ApplicationCore.Migrations
{
    ...
    [Migration("20220203075037_add_BlogArticle_Introduction")]
    partial class add_BlogArticle_Introduction
    {
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysDept", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AncestorsCode = "0.1",
                            AncestorsFullName = "",
                            CreateTime = new DateTime(2022, 2, 3, 15, 50, 37, 352, DateTimeKind.Local).AddTicks(509),
                            CurrentLevelCode = 1,
                            DeptName = "总公司",
                            IsDelete = false,
                            Level = 1,
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 2, 3, 15, 50, 37, 351, DateTimeKind.Local).AddTicks(5785),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2022, 2, 3, 15, 50, 37, 349, DateTimeKind.Local).AddTicks(3046),
            ...
            modelBuilder.Entity("Dw.Framework.Model.System.SysUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("35fe9b5d-57cc-11ec-ad18-0242ac110004"),
                            CreateTime = new DateTime(2022, 2, 3, 15, 50, 37, 351, DateTimeKind.Local).AddTicks(6959),
                            IsDelete = false,
